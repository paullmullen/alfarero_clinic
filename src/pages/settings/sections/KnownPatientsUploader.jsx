...
import { Upload, Alert, Table, Button, Progress, Space, Typography } from "antd";
...
export default function KnownPatientsUploader() {
  ...
  const columns = [
    ...
    { title: "Telephone", dataIndex: "telephone", key: "telephone" },
    {
      ...
      key: "status",
      render: (err) =>
        err ? <Text type="danger">{err}</Text> : <Text type="success">Ready</Text>,
    },
  ];
  const [t] = useTranslation("global");
    ...
    <>
      ...
      <Paragraph>
        Upload a CSV or Excel with <b>DPI, Nombre</b>,
        <b>Género</b>, <b>Edad</b>, and optional <b>Telephono</b>. DPI is
        case‑insensitive.
      </Paragraph>
